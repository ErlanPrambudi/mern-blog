        ...
        {isEditing ? (
          <>
            ...
            <div className="flex justify-end gap-2 text-xs">
              <Button type="button" seze="sm" gradientDuoTone="tealToLime" onClick={handleSave}>
                Save
              </Button>
              <Button type="button" seze="sm" gradientDuoTone="tealToLime" outline onClick={() => setIsEditing(false)}>
                Cancel
              </Button>
            </div>
          </>
          ...
          <>
            ...
            <div className="flex items-center pt-2 text-xs border-t dark:border-gray-700 max-w-fit gap-2">
              ...
              {currentUser && (currentUser._id === comment.userId || currentUser.isAdmin) && (
                <button type="button" onClick={handleEdit} className="text-gray-500 hover:text-blue-500">
                  Edit
                </button>
              )}
            </div>
